...
export type ClinicalFocus = { title: string; summary: string; prompt: string };
...
export const organs: AnatomyOrgan[] = [
  {
    ...
    clinicalFocus: { title: "Front-to-back orientation", summary: "The right ventricle forms much of the front of the heart, while the left atrium sits posteriorly near the oesophagus. This arrangement explains why a cardiac process can affect nearby structures differently.", prompt: "Rotate to compare the anterior right ventricle with the more posterior atrial region." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "Surface landmarks, functional maps", summary: "The central sulcus separates frontal motor areas from parietal sensory areas. Surface orientation makes a three-dimensional model useful before deeper pathways are introduced.", prompt: "Find the frontal and parietal landmarks, then trace their shared border." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "Airway branches at the carina", summary: "The trachea divides into main bronchi at the carina. The right main bronchus is typically wider and more vertical, an important spatial reason inhaled material more often enters the right side.", prompt: "Trace the trachea downward to the carina, then compare the two main bronchi." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "Portal inflow meets biliary drainage", summary: "At the porta hepatis, portal venous inflow, arterial supply, and biliary drainage travel in close company. Visible lobes are orientation landmarks, while internal vascular and biliary anatomy guides many procedures.", prompt: "Locate the portal-vein landmark, then compare its course with the right and left lobes." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "From filtration to drainage", summary: "The cortex contains filtration structures, the medulla supports concentration, and the collecting system funnels urine into the ureter. Seeing these regions together makes the kidney's sequence easier to understand.", prompt: "Move from cortex to medulla, then follow the exit toward the ureter." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "Light enters; neural signals leave", summary: "The cornea and iris lie at the front of the optical system, while the optic nerve leaves posteriorly as a central-nervous-system pathway. The model makes this front-to-back relationship visible.", prompt: "Compare the anterior cornea and iris with the posterior optic-nerve landmark." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "A fixed start, then a mobile loop", summary: "The duodenum is closely bound to the pancreas, whereas the jejunum is suspended by mesentery and the colon frames the small bowel. These relationships orient the abdominal cavity as a connected space.", prompt: "Begin at the duodenum, then follow the path toward jejunum and colon." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "The pancreatic head shares space with bile flow", summary: "The head sits in the duodenal curve, and the bile duct commonly passes close behind or through it. This is why a process in the pancreatic head can affect biliary drainage.", prompt: "Compare the broad head with the body, tail, and duct running through the gland." },
  ...
  },
  {
    ...
    clinicalFocus: { title: "Read skin from superficial to deep", summary: "The epidermis provides the outer barrier; the dermis carries vessels, nerves, and appendages; and the hypodermis connects skin to deeper fascia. This layered arrangement is the foundation for surface anatomy.", prompt: "Start at epidermis, then move inward through dermis to hypodermis and a follicle." },
